...
INSERT INTO addresses (user_id, street_address, city, state, postal_code, country, created_at, updated_at)
VALUES
    (1, '123 Elm St', 'Springfield', 'IL', '62701', 'USA',  CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (51, '456 Oak Ave', 'Springfield', 'IL', '62702', 'USA', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (101, '789 Maple Dr', 'Chicago', 'IL', '60601', 'USA', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);